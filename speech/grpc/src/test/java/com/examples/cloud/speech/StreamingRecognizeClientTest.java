...
//    URI uri = new File("resources/Shortsefl.raw").toURI();
//	//URI uri = new File("gs://recordings_agh/SelfRecording31Jul201620.raw").toURI();  
...
//    //AsyncRecognizeClient client = new AsyncRecognizeClient(channel, path.toString(), 16000);
//    //AsyncRecognizeClient client = new AsyncRecognizeClient(channel, uri, 16000);
//    
//    client.recognize();
//    assertThat(writer.toString()).contains("transcript: \"male\"");
//  }
//
//  @Test
